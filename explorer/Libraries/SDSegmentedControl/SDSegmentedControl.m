...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:frame]))
    {
        ...
        if (floor(NSFoundationVersionNumber) <= NSFoundationVersionNumber_iOS_6_1)
        {
            ...
            self.titleFont = [UIFont fontWithName:@"HelveticaNeue-Light" size:14];
        }
        else
        {
            self.titleFont = [UIFont fontWithName:@"HelveticaNeue-UltraLight" size:14];
            self.selectedTitleFont = [UIFont fontWithName:@"HelveticaNeue-Light" size:14];
        }
