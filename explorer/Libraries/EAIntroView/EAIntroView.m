...
- (void)crossDissolveForOffset:(float)offset {
    ...
    if(self.titleView) {
        if([self showTitleViewForPage:(int)page] && [self showTitleViewForPage:(int)page+1]) {
            [self.titleView setAlpha:1.0];
        } else if(![self showTitleViewForPage:(int)page] && ![self showTitleViewForPage:(int)page+1]) {
            [self.titleView setAlpha:0.0];
        } else if([self showTitleViewForPage:(int)page]) {
